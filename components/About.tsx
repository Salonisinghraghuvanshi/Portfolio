...
const words = [
  ...
  { text: '6 YEARS', accent: '#E1306C' },
  { text: 'OF', accent: null },
  { text: 'EXPERIENCE', accent: null },
  { text: 'WHO', accent: null },
  { text: 'WORKS', accent: null },
  { text: 'WITH', accent: null },
  { text: 'THE', accent: null },
  { text: 'TOP', accent: null },
  { text: '1%', accent: '#0A66C2' },
  { text: 'OF', accent: null },
          ...
          <div className="ab-stats">
            {[
              ...
              <div
                ...
                style={{ '--ac': s.accent, animationDelay: `${0.6 + i * 0.12}s` } as React.CSSProperties}
              >
...
const css = `
  ...
  /* orbs */
  .ab-orb { position:fixed;border-radius:50%;filter:blur(110px);pointer-events:none;z-index:0; }
  .ab-root .o1 { width:600px;height:600px;background:rgba(255,32,32,.055);top:-150px;right:-150px;animation:ab-drift 22s ease-in-out infinite alternate; }
  .ab-root .o2 { width:500px;height:500px;background:rgba(10,102,194,.065);bottom:-100px;left:-100px;animation:ab-drift 28s ease-in-out infinite alternate-reverse; }
  .ab-root .o3 { width:320px;height:320px;background:rgba(225,48,108,.04);top:45%;left:42%;animation:ab-drift 18s ease-in-out infinite alternate; }
  @keyframes ab-drift { from{transform:translate(0,0)scale(1)} to{transform:translate(35px,25px)scale(1.06)} }
  ...
  .is-visible .ab-eyebrow { opacity:1;transform:none; }

  .ab-dot {
    width:6px;height:6px;background:#4ade80;border-radius:50%;
    animation:ab-blink 2.4s ease infinite;display:inline-block;
  }
  ...
  .is-visible .ab-word { opacity:1; transform:none; }
  ...
  /* plain words */
  .ab-headline .ab-word:not([style*="--ac: #"]) .ab-word-inner {
    background: linear-gradient(140deg,#fff 35%,rgba(255,255,255,.5));
    -webkit-background-clip: text;
    -webkit-text-fill-color: transparent;
    background-clip: text;
  }

  /* accent words keep their color */
  .ab-word-inner[style] {
  ...
  .is-visible .ab-stats { opacity:1;transform:none; }
  ...
  .ab-stat-card::before {
    ...
    background:radial-gradient(ellipse at 50% 0%, color-mix(in srgb, var(--ac) 10%, transparent) 0%, transparent 70%);
    opacity:0;transition:opacity .35s;pointer-events:none;border-radius:inherit;
  }
  .ab-stat-card:hover { transform:translateY(-6px);border-color:var(--ac);box-shadow:0 24px 60px rgba(0,0,0,.55); }
  ...
  .ab-ring {
    position:absolute;bottom:-56px;right:-56px;width:140px;height:140px;
    border-radius:50%;border:1px solid var(--ac,rgba(255,255,255,.08));opacity:.09;pointer-events:none;
  }
  .ab-ring.r2 { bottom:-80px;right:-80px;width:190px;height:190px;opacity:.04; }

  .ab-stat-val {
    font-family:var(--fd);font-size:2rem;font-weight:800;
    letter-spacing:-.04em;color:var(--ac);line-height:1;
  }
  .ab-stat-label {
    font-size:11px;color:var(--muted);font-weight:400;letter-spacing:.08em;text-transform:uppercase;
  }
`